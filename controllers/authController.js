  ...
  try {
    ...
    try {
      newUser = await pool.query(
        ...
        (nombre, primer_apellido, segundo_apellido, fecha_nacimiento, institucion, email, password, email_verified, verification_token)
      ...
      // Fallback si la migración de columnas aún no se aplicó
      if (e.code === "42703") {
        newUser = await pool.query(
          `INSERT INTO usuarios
