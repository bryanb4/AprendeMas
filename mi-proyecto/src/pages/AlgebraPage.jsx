...
// Lista de temas de Álgebra (extraída del Dashboard original)
const temasAlgebra = [
  "Expresiones algebraicas, ecuaciones e inecuaciones en una variable",
        ...
        <main className="main-content">
          ...
          <div className="contenido-card">
            ...
            <div className="cuerpo-texto">
              ...
              <div className="nota-box" style={{ background: '#FFF8E1' }}>
                💡 ¡Estamos trabajando para traerte el mejor material!
              </div>
            </div>
          </div>
        </main>
